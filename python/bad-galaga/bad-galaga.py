...
pygame.display.set_caption("bad galaga")

BG = pygame.transform.scale(pygame.image.load("cutebg.jpg"), (WIDTH, HEIGHT))
...
def main():
    ...
    player = pygame.Rect(20, HEIGHT - PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT)
